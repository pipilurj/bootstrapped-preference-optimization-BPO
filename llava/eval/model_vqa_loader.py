...
def eval_model(args):
    ...
    disable_torch_init()
    print('=====')
    # harm_tokenizer = AutoTokenizer.from_pretrained("/home/qlianab/TianyangHan/workout/harmfuldetec/open3b_merge", use_auth_token=True)
    # harm_tokenizer.pad_token = harm_tokenizer.eos_token
    # harm_detector = AutoModelForSequenceClassification.from_pretrained(
    #     "/home/qlianab/TianyangHan/workout/harmfuldetec/open3b_merge", num_labels=1, torch_dtype=torch.bfloat16
    # ).cuda()

    # detoxifier_tokenizer = AutoTokenizer.from_pretrained("/home/qlianab/TianyangHan/workout/harmfuldetec/llama2-merge")
    # detoxifier = AutoModelForCausalLM.from_pretrained("/home/qlianab/TianyangHan/workout/harmfuldetec/llama2-merge", torch_dtype=torch.bfloat16).cuda()
